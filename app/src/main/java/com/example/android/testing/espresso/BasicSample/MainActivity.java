...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChangeTextBt = (Button) findViewById(R.id.changeTextBt);
        mActivityChangeTextBtn = (Button) findViewById(R.id.activityChangeTextBtn);

        mChangeTextBt.setOnClickListener(this);
        mActivityChangeTextBtn.setOnClickListener(this);
    }
